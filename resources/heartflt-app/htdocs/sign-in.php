...
.login-form button a:hover {
    background-color: rgb(220, 177, 120);
}
.login-form button i {
    margin-right: 10px;
}
...
.login-form .links a:hover {
    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                <h1 ><i class="fa-solid fa-paw"> </i>H E A R T F E L T  H O M E S</h1>
                </div>

                    <div class="main-content">
                        <div class="text">
                        <h2>Find Your Pawfect Companion Today!</h2>
